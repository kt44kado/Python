...
# sft-chainlit02.pyを元に、Dr.Sum-MCP部分を追加したが、接続が切れてしまうコードになっているんだと。
# ⇒　Copilotに手直ししてもらった ⇒ sft-chainlit03.py
import asyncio
import json
import os
...
async def setup_agent():
    ...
    model_client = AzureOpenAIChatCompletionClient(
        ...
        azure_deployment=os.getenv("DEPLOYMENT_NAME"),  # Azureポータルでのデプロイ名,
